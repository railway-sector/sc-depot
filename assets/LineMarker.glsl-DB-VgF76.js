import{xW as te,JL as ie,JM as re,Im as ae,JN as se,JO as oe,Iq as o,JE as ne,IV as ce,JD as le,Ip as y,JP as pe,JQ as de,IZ as N,Io as he,Ir as ve,Is as ue,Jj as me,Iu as fe,JR as R,JS as U,JT as ge,JU as Se,I_ as Pe,gb as ye,r7 as _e,jY as we,r9 as xe,_ as $e,rb as C,Iw as E,Ix as ze,Iy as q,rc as L,IA as be,IB as Ve,ID as ke,JV as Oe,JW as B,JX as Y,JY as Te,JZ as We,J_ as De,ak as d,an as Ce,J0 as Me,IF as m,fN as Le,IH as M,J3 as Ie,J$ as H,tp as je,Jv as Je,K0 as Ae,II as Fe,d5 as K,kN as Ne,g8 as Q,n as Z,K1 as Re}from"./index-BEANZrvs.js";function G(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,V=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),_&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
